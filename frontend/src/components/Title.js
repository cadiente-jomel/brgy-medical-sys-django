const Title = ({ title, icon, btnText, btnIcon }) => {
    return (
            // <!-- This example requires Tailwind CSS v2.0+ -->
        <div className=" p-4 lg:flex lg:items-center lg:justify-between title">
...
Title.defaultProps = {
    title: 'Home',
    icon: 'fas fa-home home mr-2 text-default',
    btnText: 'Citizen Record',
    btnIcon: 'fas fa-users mr-2'
}
